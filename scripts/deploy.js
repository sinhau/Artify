async function main() {
  ...
  // Deploy SVGGenerator (already deployed at 0x0D4e777caBf9f311879cA734FB8556CAc9fA03dC)
  ...
  const SecretMessagesContractFactory = await ethers.getContractFactory(
    "SecretMessages",
    {
      libraries: {
        // HSLGenerator: HSLGeneratorContract.address,
        ...
        HSLGenerator: "0x7e1D9928faFb907009cd6Db31bae488c0123b63C",
        SVGGenerator: "0x0D4e777caBf9f311879cA734FB8556CAc9fA03dC",
  ...
  const SecretMesseagesContract = await SecretMessagesContractFactory.deploy();
  console.log("SecretMessages deployed to address:", SecretMesseagesContract.address);
}
